...
const CMCTableRow = ({ starNum, coinName, coinSymbol, coinIcon, showBuy, hRate, dRate, hRateIsIncrement, price, marketCapValue, volumeCryptoValue, volumeValue, circulatingSupply }: CMCTableRowProsp) => {
    ...
    return (
        <tbody className={styles.tableRow}>
            <tr>
                ...
                <td>
                    <Rate isIncrement={false} rate={`${formatNum(dRate)}%`} />
                </td>
                <div>
